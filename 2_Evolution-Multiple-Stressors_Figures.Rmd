...
This R notebook contains the code used to plot the figures in the paper: *Rapid Evolution Generates Synergism Between Multiple Stressors and Complicates Ecological Restoration*. 

Dataframes generated in the `Rotifer-Stressor-Analysis` notebook are used. 
...
#### For Removal of Stressors - figure 3#####
Na_in_Control <- subset(rot_pop, treat_num == "9")
Cu_in_Control <- subset(rot_pop, treat_num == "17")
Temp_in_Control <- subset(rot_pop, treat_num == "25")
...
text(growth_trend_data$effect1 ~ growth_trend_data$treatment_J, labels=growth_trend_data$number, family = "Times", cex = 1.5, 
     col = rgb(0.3, 0.3, 0.3))
...
This is for the third, diagonal axis (defining the combined effect of stressors).Just divide by two to project onto the diagonal. 
...
- **Calculate means of populations and cost of removing stressors** 
...
```{r, echo=FALSE, fig.width=7.5, fig.height=5, include=TRUE}
...
plot(1, type="n", xlab="", ylab="", bty = "n", yaxt = 'n', xaxt = 'n',
     cex.main = 2.5,
     xlim=c(-0.01, 0.26), ylim=c(-0.01, 0.26))
...
### Control points ### 
points(x = Control_in_Na$mean_growth,
       y = Control_in_Cu$mean_growth,
       col = j.blue_alpha, pch = 19, cex = 5)

points(x = c(Na_in_Na$mean_growth, 
             Cu_in_Na$mean_growth+Cu_removed),
       y = c(Na_in_Cu$mean_growth+Na_removed, 
             Cu_in_Cu$mean_growth),
       col = j.red, pch = 19, cex = 5)

points(x = NaCu_in_Na$mean_growth+Cu_removed,
       y = NaCu_in_Cu$mean_growth+Na_removed,
       col = j.red, pch = 19, cex = 5)

text(x = c(Na_in_Na$mean_growth, 
           Cu_in_Na$mean_growth+Cu_removed, 
           NaCu_in_Na$mean_growth+Cu_removed),
       y = c(Na_in_Cu$mean_growth+Na_removed, 
             Cu_in_Cu$mean_growth, 
             NaCu_in_Cu$mean_growth+Na_removed),
...
points(x = mgrowth_Control_in_Control,
...
### Control points ### 
points(x = Control_in_Na$mean_growth,
       y = Control_in_Temp$mean_growth,
       col = j.blue_alpha, pch = 19, cex = 5)

points(x = c(Na_in_Na$mean_growth, 
             Temp_in_Na$mean_growth+Temp_removed),
       y = c(Na_in_Temp$mean_growth+Na_removed, 
             Temp_in_Temp$mean_growth),
       col = j.red, pch = 19, cex = 5)

points(x = NaTemp_in_Na$mean_growth+Temp_removed,
       y = NaTemp_in_Temp$mean_growth+Na_removed,
       col = j.red, pch = 19, cex = 5)

text(x = c(Na_in_Na$mean_growth, 
             Temp_in_Na$mean_growth+Temp_removed, 
             NaTemp_in_Na$mean_growth+Temp_removed),
       y = c(Na_in_Temp$mean_growth+Na_removed, 
             Temp_in_Temp$mean_growth, 
             NaTemp_in_Temp$mean_growth+Na_removed),
     labels=c(Na_in_Na$label, 
              Temp_in_Temp$label,
...
### Control points ### 
points(x = Control_in_Cu$mean_growth,
       y = Control_in_Temp$mean_growth,
       col = j.blue_alpha, pch = 19, cex = 5)

points(x = c(Cu_in_Cu$mean_growth, 
             Temp_in_Cu$mean_growth+Temp_removed),
       y = c(Cu_in_Temp$mean_growth+Cu_removed, 
             Temp_in_Temp$mean_growth),
       col = j.red, pch = 19, cex = 5)

points(x = CuTemp_in_Cu$mean_growth+Temp_removed,
       y = CuTemp_in_Temp$mean_growth+Cu_removed,
       col = j.red, pch = 19, cex = 5)

text(x = c(Cu_in_Cu$mean_growth, 
             Temp_in_Cu$mean_growth+Temp_removed, 
             CuTemp_in_Cu$mean_growth+Temp_removed),
       y = c(Cu_in_Temp$mean_growth+Cu_removed, 
             Temp_in_Temp$mean_growth, 
             CuTemp_in_Temp$mean_growth+Cu_removed),
...
points(x = c(mgrowth_Control_in_Na, mgrowth_NaCu_in_Na+Cu_removed, mgrowth_Control_in_Control),
       y = c(mgrowth_Control_in_Cu, mgrowth_NaCu_in_Cu+Na_removed, mgrowth_Control_in_Control),
       col = c(j.blue, j.red, "black"), pch = 19, cex = c(8, 8, 2))

points(x = c(mgrowth_Control_in_Na, 0, mgrowth_Na_in_Na, 0),
       y = c(0, mgrowth_Control_in_Cu, 0, mgrowth_Cu_in_Cu),
       col = c(j.blue, j.blue, j.red, j.red), pch = 19, cex = 8)

arrows(x0 = c(mgrowth_Control_in_Na+segrowth_Control_in_Na, 
              mgrowth_Na_in_Na+segrowth_Na_in_Na,
             0, 0),
      x1 = c(mgrowth_Control_in_Na-segrowth_Control_in_Na, 
              mgrowth_Na_in_Na-segrowth_Na_in_Na,
             0, 0),
      y0 = c(0, 0,
             mgrowth_Control_in_Cu+segrowth_Control_in_Cu, 
             mgrowth_Cu_in_Cu+segrowth_Cu_in_Cu),
      y1 = c(0, 0,
             mgrowth_Control_in_Cu-segrowth_Control_in_Cu, 
             mgrowth_Cu_in_Cu-segrowth_Cu_in_Cu),
       col = c(j.blue, j.red),
...
arrows(x0 = c(mgrowth_Control_in_Na+segrowth_Control_in_Na,
              mgrowth_NaCu_in_Na+std.error(NaCu_in_Na$mean_growth)+Cu_removed,
              mgrowth_Control_in_Na, 
              mgrowth_NaCu_in_Na+Cu_removed), 
       ...
       y0 = c(mgrowth_Control_in_Cu, 
              mgrowth_NaCu_in_Cu+Na_removed,
              mgrowth_Control_in_Cu+segrowth_Control_in_Cu,
              mgrowth_NaCu_in_Cu+std.error(NaCu_in_Cu$mean_growth)+Na_removed), 
       
       y1 = c(mgrowth_Control_in_Cu, 
              mgrowth_NaCu_in_Cu+Na_removed, 
              mgrowth_Control_in_Cu-segrowth_Control_in_Cu,
              mgrowth_NaCu_in_Cu-std.error(NaCu_in_Cu$mean_growth)+Na_removed),
       col = c(j.blue, j.red, j.blue, j.red),
...
text(x = c(mgrowth_Control_in_Na, 0, mgrowth_Na_in_Na, 0),
       y = c(0, mgrowth_Control_in_Cu, 0, mgrowth_Cu_in_Cu),
     labels = c("S", "C", "S'", "C'"), family = "Times", 
     col = rgb(0.4, 0.4, 0.4), cex = 2)

text(x = c(mgrowth_Control_in_Na, mgrowth_NaCu_in_Na+Cu_removed),
     y = c(mgrowth_Control_in_Cu, mgrowth_NaCu_in_Cu+Na_removed),
     labels = c("SC", "SC'"), family = "Times", 
     col = rgb(0.4, 0.4, 0.4), cex = 2)
...
points(x = c(mgrowth_Control_in_Na, mgrowth_NaTemp_in_Na+Temp_removed, mgrowth_Control_in_Control),
       y = c(mgrowth_Control_in_Temp, mgrowth_NaTemp_in_Temp+Na_removed, mgrowth_Control_in_Control),
       col = c(j.blue, j.red, "black"), pch = 19, cex = c(8, 8, 2))


points(x = c(mgrowth_Control_in_Na, 0, mgrowth_Na_in_Na, 0),
       y = c(0, mgrowth_Control_in_Temp, 0, mgrowth_Temp_in_Temp),
       col = c(j.blue, j.blue, j.red, j.red), pch = 19, cex = 8)
...
arrows(x0 = c(mgrowth_Control_in_Na+segrowth_Control_in_Na, 
      ...
      x1 = c(mgrowth_Control_in_Na-segrowth_Control_in_Na, 
             ...
             0, 0),
      y0 = c(0, 0,
             mgrowth_Control_in_Temp+segrowth_Control_in_Temp, 
             mgrowth_Temp_in_Temp+segrowth_Temp_in_Temp),
      y1 = c(0, 0,
             mgrowth_Control_in_Temp-segrowth_Control_in_Temp, 
              mgrowth_Temp_in_Temp-segrowth_Temp_in_Temp),
       col = c(j.blue, j.red),
...
arrows(x0 = c(mgrowth_Control_in_Na+segrowth_Control_in_Na,
              mgrowth_NaTemp_in_Na+std.error(NaTemp_in_Na$mean_growth)+Temp_removed,
              mgrowth_Control_in_Na, 
              mgrowth_NaTemp_in_Na+Temp_removed), 
       ...
       y0 = c(mgrowth_Control_in_Temp, 
              mgrowth_NaTemp_in_Temp+Na_removed,
              mgrowth_Control_in_Temp+segrowth_Control_in_Temp,
              mgrowth_NaTemp_in_Temp+std.error(NaTemp_in_Temp$mean_growth)+Na_removed), 
       
       y1 = c(mgrowth_Control_in_Temp, 
              mgrowth_NaTemp_in_Temp+Na_removed, 
              mgrowth_Control_in_Temp-segrowth_Control_in_Temp,
              mgrowth_NaTemp_in_Temp-std.error(NaTemp_in_Temp$mean_growth)+Na_removed),
       col = c(j.blue, j.red, j.blue, j.red),
...
text(x = c(mgrowth_Control_in_Na, mgrowth_NaTemp_in_Na+Temp_removed),
     y = c(mgrowth_Control_in_Temp, mgrowth_NaTemp_in_Temp+Na_removed),
     labels = c("ST", "ST'"), family = "Times", 
     col = rgb(0.4, 0.4, 0.4), cex = 2)
...
points(x = c(mgrowth_Control_in_Cu, mgrowth_CuTemp_in_Cu+Temp_removed, mgrowth_Control_in_Control),
       y = c(mgrowth_Control_in_Temp, mgrowth_CuTemp_in_Temp+Cu_removed, mgrowth_Control_in_Control),
       col = c(j.blue, j.red, "black"), pch = 19, cex = c(8, 8, 2))

points(x = c(mgrowth_Control_in_Cu, 0, mgrowth_Cu_in_Cu, 0),
       y = c(0, mgrowth_Control_in_Temp, 0, mgrowth_Temp_in_Temp),
       col = c(j.blue, j.blue, j.red, j.red), pch = 19, cex = 8)


arrows(x0 = c(mgrowth_Control_in_Cu+segrowth_Control_in_Cu, 
              mgrowth_Cu_in_Cu+segrowth_Cu_in_Cu,
             0, 0),
      x1 = c(mgrowth_Control_in_Cu-segrowth_Control_in_Cu, 
             mgrowth_Cu_in_Cu-segrowth_Cu_in_Cu, 
             0, 0),
      y0 = c(0, 0,
             mgrowth_Control_in_Temp+segrowth_Control_in_Temp, 
...
arrows(x0 = c(mgrowth_Control_in_Cu+segrowth_Control_in_Cu,
              mgrowth_CuTemp_in_Cu+std.error(CuTemp_in_Cu$mean_growth)+Temp_removed,
              mgrowth_Control_in_Cu, 
              mgrowth_CuTemp_in_Cu+Temp_removed), 
       ...
       y0 = c(mgrowth_Control_in_Temp, 
              ...
              mgrowth_Control_in_Temp+segrowth_Control_in_Temp,
              mgrowth_CuTemp_in_Temp+std.error(CuTemp_in_Temp$mean_growth)+Cu_removed), 
...
text(x = c(mgrowth_Control_in_Cu, 0, mgrowth_Cu_in_Cu, 0),
       y = c(0, mgrowth_Control_in_Temp, 0, mgrowth_Temp_in_Temp),
     labels = c("C", "T", "C'", "T'"), family = "Times", 
     col = rgb(0.4, 0.4, 0.4), cex = 2)

text(x = c(mgrowth_Control_in_Cu, mgrowth_CuTemp_in_Cu+Temp_removed),
     y = c(mgrowth_Control_in_Temp, mgrowth_CuTemp_in_Temp+Cu_removed),
     labels = c("CT", "CT'"), family = "Times", 
     col = rgb(0.4, 0.4, 0.4), cex = 2)
...
#arrows( x0 = figure_3b$environment_j, 
#        x1 = figure_3b$environment_j, 
#        y0 = figure_3b$mean_growth - figure_3b$se_growth, 
#        y1 = figure_3b$mean_growth + figure_3b$se_growth,
#        col = c(j.blue_alpha, j.blue_alpha, j.blue_alpha, j.red_alpha),
#        code = 3, length = 0.07, angle = 90, lwd = 1)
