...
text(growth_trend_data$effect1 ~ growth_trend_data$treatment_J, 
     labels=growth_trend_data$number, family = "Times", cex = 1.5, 
     col = rgb(0.3, 0.3, 0.3))
```
<br>
...
```{r, echo=TRUE}
# ad_na_to_cu = the adaptation of the na evolved line in the cu environment 
...
Comparing the actual adaptation to multiple stressors and the taxicab/L1 norm/manhattan distance between non-evolved and evolved populations in performance space. 
